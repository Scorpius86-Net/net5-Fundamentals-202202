...
namespace Net5.Fundamentals.AspNet.Data.Repositories
{
    public class CustomerRepository
    {
        ...
        public Customer Get(int customerId)
        {
            ...
            customer = _database.Get<Customer>(query, CommandType.Text);
        ...
        public Customer Insert(Customer customer)
        {
            string query = @$"
                ...
                VALUES
                    ...
                    ,'{customer.ZipCode}')
                ";
            customer = _database.Insert<Customer>(query, CommandType.Text);
        ...
        public Customer Update(Customer customer)
        {
            string query = @$"
                ...
                ";
            customer = _database.Update<Customer>(query, CommandType.Text);
        ...
        public int Remove(int customerId)
        {
            string query = @$"
                ...
                ";
            int result = _database.Execute(query, CommandType.Text);
        ...
        public bool Exists(int customerId)
        {
            ...
            exists = _database.Get<int>(query, CommandType.Text) > 0;
